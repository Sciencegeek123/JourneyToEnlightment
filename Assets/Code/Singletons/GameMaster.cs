...
public class GameMaster : MonoBehaviour {
    ...
    void Start() {
        ...
        SceneManager.LoadScene("WallScene1", LoadSceneMode.Additive);
        SceneManager.LoadScene("WallScene2", LoadSceneMode.Additive);
        SceneManager.LoadScene("WallScene3", LoadSceneMode.Additive);
        SceneManager.LoadScene("WallScene4", LoadSceneMode.Additive);
